          ...
          <div className={`px-8 pb-8 ${footerClassName}`}>
            <div className={`mt-10 flex ${currentStep !== 1 ? "justify-between" : "justify-end"}`}>
              ...
              <button
                ...
                disabled={(isLastStep && !isCredentials) || isLoading}
                title={
                ...
                className={`duration-350 flex items-center justify-center rounded-full py-1.5 px-3.5 font-medium tracking-tight text-white transition ${
                  (isLastStep && !isCredentials) || isLoading
...
function LoadingSpinner() {
  return (
    <motion.div
      className="h-10 w-10 rounded-full border-4 border-t-4 border-green-500 border-t-transparent animate-spin"
      aria-label="Loading"
    />
  );
}
